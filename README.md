...
![Average Shots per Point by Surface](Turkey.png)
...
**Figure 2.** This image shows the five-number summary for clay, grass, and hard courts, providing the minimum, Q1, median, Q3, and maximum values for average shots per point across each surface.
